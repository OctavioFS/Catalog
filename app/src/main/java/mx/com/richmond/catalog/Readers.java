...
public class Readers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(c.moveToFirst()) {
            TextView textReaders = (TextView) this.findViewById(R.id.textReaders);
            textReaders.setText(c.getString(2));
        }

        GridView cuadrosReaders = (GridView) findViewById(R.id.cuadrosReaders);
        cuadrosReaders.setAdapter(new readersAdapter(this, seriesId));
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()!=0) {
            Intent intent = new Intent(Readers.this, Series.class);
    ...
    {
        Intent intent = new Intent(Readers.this, First.class);
        startActivity(intent);
    }
    public void goAbout(View view)
    {
        Intent intent = new Intent(Readers.this, About.class);
        startActivity(intent);
    }
    public void goWhere(View view)
    {
        Intent intent = new Intent(Readers.this, Where.class);
        startActivity(intent);
    }
}
